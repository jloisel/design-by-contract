...
import com.jloisel.material.alloy.AlloyMaterialModule;
import com.jloisel.powerband.api.PowerBand;
import com.jloisel.wheel.api.Wheel;
import com.jloisel.wheel.immutable.ImmutableWheelModule;
...
public final class Main {
	...
	public static void main(final String[] args) {
		...
		final Iterable<Wheel> wheels = car.wheels();
		LOGGER.info("Wheels: " + Iterables.getFirst(wheels, null));
	}
}
